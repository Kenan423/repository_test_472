...
**A1:** The file name is a link to a website
...
**A2:** There are 9777 records of seismic activity. They are differentiated between earthquakes and other seismic activity and have information about where and when they took place.
...
**A3:** The deepest one is 669.98 and its magnitude is 4.2
...
**A4:** There are 12 earthquakes with magnitudes greater than 6
...
earthquakes |>
  filter(mag >6 & 20>depth)


```

**A5:** There are 5 earthquakes in the data set that fit both.
...
**A8:** There is a column called type that have different types of tremors.
...
earthquakes <- earthquakes |>
  mutate(serious = case_when(mag > 3 ~ 'Serious',
  .default = 'Not serious'))
