...
**Answer: 60712 observations or records or rows and 8 variables or columns.**
...
In the space below, write the data type for the "id" column and the "seats" column (it's in light gray, offset by \< \>). **Answer: chr for id and dbl for seats.**
...
**Answer: The first line is selecting the umd_courses dataset.**

The second line is grouping the data by the terms.

The third and fourth line is adding up all the classes in each term.
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer: A new line was added that arranges the data by the number of classes per term. The data is listed in a descending order with the highest number of classes listed first.**
...
**Answer: The number of classes is now divided by term and department. The comma between term and department allowed the change.**
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer: The total number of seats for the classes is listed in addition to the class count and the term. The sum for the total number of seats is added to the code and it is only grouped by term.**
...
Compared to the previous codeblock, what has changed and how did that affect the result? What do the top terms have in common? **Answer: The mean number of seats and the median number of seats have been added to the code and are now displayed on the chart. Both charts are arranged by the total number of seats.**
...
**Answer: The group by is changed from term to department, and the departments are now listed in the chart.**
...
1.  Is it possible to target multiple data sets in a single line of code for finding sums and means of data?

2.  Which instructor has taught the most classes?

3.  Which term has the most classes?
