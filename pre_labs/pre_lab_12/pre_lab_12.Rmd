...
Maryland Sen. Ben Cardin's website has a list all of his press releases. We're going to analyze the text of those releases using tidytext. Our starting question: what words or phrases appear most in Cardin's press releases?

To answer this question, we'll use the text of those releases. We have the URLs of 999 of Cardin's press releases. Let's read in this data and examine it:

### Task 2: Read in data

**Task** Run the following code and describe the dataframe it outputs. **Answer** The data shows the titles and url's.
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **Answer** The unique list of words categorizes the following words as unique so they are easy to target.
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **Answer** The output lists all the unique words individually.
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **Answer** The graphic shows the most common words, which are simple and basic ones like "the" and "and."
...
**Task** Run the following code and describe the results. **Answer** The results show the number of times the word is used and the percentage it is used.
...
**Task** Run the following code and describe the results. **Answer** The most used pairs of words are listed in order of frequency.
