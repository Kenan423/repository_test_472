...
**Task** Run the following code and describe the dataframe it outputs. **Answer** The dataframe shows population growth, 
...
**Task** Run the following code. Describe the plot. What pattern do you see? **Answer** There is some loose correlation. As the population increases gdp increases.
...
**Task** Run the following code. Describe the plot. What do you see? **Answer** The slope is going slightly downward. There isn't much correlation.
...
**Task** Run the following code. Describe the table output in terms of the strength of relationships between the variables. What do you see? **Answer** pop_change_2021 and per_pupil_2021 have the strongest relationship, while gdp_growth_2021 and per_pupil_2021 have the weakest relationship.
...
**Task** Run the following code. Describe the model output. What do you see? **Answer** the cor is -0.411, t = -3.12, df = 48, and the p-value = 0.00301
...
**Task** Run the following code. Describe the model output. What do you see? **Answer** The cor is -0.059, t = -0.415, df = 48, and the p-value = 0.679
...
**Task** Run the following code. Describe the table. What do you see? **Answer** mean_gdp_growth was higher for Biden, mean_per_pupil_education was higher for Biden, and mean_pop_growth was higher for Trump.
...
**Task** Run the following code. Describe the output. What do you see? **Answer** It displays the mean population change for both Biden and Trump. t = -1.828, df = 45.47, and the p-value = 0.07411.
...
**Task** Run the following code. Describe the output. What do you see? **Answer** There is strong statistical significance for this data. The mean in group Biden is higher than the mean in group Trump.
