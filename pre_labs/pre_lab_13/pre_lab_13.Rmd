...
**Task** Run the following code. Describe the plot. What pattern do you see? **Answer**
...
**Task** Run the following code. Describe the plot. What do you see? **Answer**
...
**Task** Run the following code. Describe the table output in terms of the strength of relationships between the variables. What do you see? **Answer**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer**
...
**Task** Run the following code. Describe the table. What do you see? **Answer**
...
**Task** Run the following code. Describe the output. What do you see? **Answer**
...
**Task** Run the following code. Describe the output. What do you see? **Answer** There is strong statistical significance for this data.
