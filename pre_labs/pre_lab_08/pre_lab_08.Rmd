...
**Task** Run the following code to load the data. In the space below, indicate how many rows and columns it has. **Answer** It has 3822 rows and 4 columns.
...
**Task** Run the following code to add a month column to our dataframe using lubridate and count the number of calls for each month. In the space below, explain what each step of the code below is doing in English. Note the "label=TRUE" part in the mutate statement. **Answer** The mutate in the code is altering the data in the date column and displaying it under the column "month." The data is then grouped by the month and the number of total calls is then found and displayed in descending order from highest number of calls.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** A gray box pops up in the space below.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** A bar chart appears showing number of calls for each month.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** The columns are now ordered by total calls from lowest to highest.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** The chart is now a horizontal bar chart.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** The background color for the chart is white instead of grey.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer** The background color is now blue and the chart has fewer lines.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** There is now a title for the chart and a caption for the source of the data. The titles for the rows have also changed.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** There is a chart displaying the date and the total number of calls.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** The data has turned into a line chart.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** The code now displays the weeks in the data set.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** The text displaying the days of the week is now angled differently than before making it easier to read.
