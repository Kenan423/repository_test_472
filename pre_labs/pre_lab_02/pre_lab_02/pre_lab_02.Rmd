...
**Answer**
This is important because we can use this variable for future data gathering.
...
**Answer:** The dates are displayed differently, with the year being displayed first followed by the month then day. The data type also changed from <chr> to <date>.
...
**Answer** The month column displays the dates, with each month being displayed once. It appears that the data in the total_amount column represents the total for the entire month displayed in the month column.
...
**Answer** I think the code is adding the columns for the various candidates plus write_ins to create a new column with the total number of votes. I also think that the code is creating a new column for the percentage of votes for Moore.
...
**Answer** The code now displays the highest percentage of votes for Moore in a descending order. The code arranging the percent of votes for Moore in a descending order was added.
...
**Answer** It is more interesting if you are interested in finding which county has the lowest percentage of votes for Moore.
...
**Answer** str_to_title and str_to_lower are two functions similar to str_to_upper. str_to_title capitalizes only the first letter of each word and str_to_lower converts all the letters to lower case.
...
**Answer** The mutate statement is creating a new column with the states selected below. 
