...
**Task** Run the following code to load data. Describe what you see in the answer space below. What columns exist in this data? **Answer** Zipcodes, the names of the zipcodes, and the shape of the area are some of the columns that exist in the data set.
...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **Answer** md_zips contains mostly numerical data of zip codes, object id's and the shape and length of the zip codes. 
...
**Task** Run the following code. Describe the output in the space below. **Answer** The output is a map of the state of Maryland with each zipcode outlined.
...
**Task** Run the following code. Describe the output in the space below. **Answer** The code installed the library tigris.
...
**Task** Run the following code. Describe the output in the space below. **Answer** The names of the counties are listed along with their GEOID and their geometry among other factors.
...
**Task** Run the following code. Describe the output in the space below. **Answer** The names of the counties are listed on the chart along with numerical data for each county.
...
**Task** Run the following code. Describe the output in the space below. **Answer** A map of the state of Maryland with each county outlined is displayed.
...
**Task** Run the following code. Describe the output in the space below. **Answer** The state of Maryland is shown with both the zip codes and the counties outlined.
...
**Task** Run the following code. Describe the output in the space below. **Answer** The chart lists the zipcodes and the number of foreclosures in each zipcode for the month of March 2023.
...
**Task** Run the following code. Describe the output in the space below. **Answer** A list of the zip codes along with their geometry and the number of foreclosures for the month of March 2023 is displayed.
...
**Task** Run the following code. Describe the output in the space below. **Answer** A color coded map of Maryland is displayed showing the number of foreclosures in each zipcode.
...
**Task** Run the following code. Describe the output in the space below. Be sure to input your census api key. **Answer** The code loads the libraries with the api key.
...
**Task** Run the following code. Describe the output in the space below. **Answer** The population for each Maryland county is displayed as well as the number of foreclosure notices for each county.
...
**Task** Run the following code. Describe the output in the space below. **Answer** The estimated population for Maryland counties is displayed.
...
**Task** Run the following code. Describe the output in the space below. **Answer** The Maryland county population and the foreclosure notices per county are displayed.
...
**Task** Run the following code. Describe the output in the space below. **Answer** The Maryland county and the population are displayed.
...
**Task** Run the following code. Describe the output in the space below. **Answer** The data sets containing the Maryland foreclosures and the county populations are joined.
...
**Task** Run the following code. Describe the output in the space below. **Answer** The rate of foreclosures per county are listed.
...
**Task** Run the following code. Describe the output in the space below. **Answer** A color coded map of Maryland counties based on foreclosure rate is displayed.
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer** A color coded map of Maryland counties based on foreclosure rate is displayed.
