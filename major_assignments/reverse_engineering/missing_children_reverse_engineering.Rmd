...
population_by_age <- population_by_age |>
  clean_names()
private_enrollment_by_grade <- private_enrollment_by_grade |>
  clean_names()
public_enrollment_by_grade <- public_enrollment_by_grade |>
  clean_names() 
missing_kids_analysis <- Missing_Kids_Analysis |>
  clean_names()
school_aged_population_changes <- School_Aged_Population_Changes |>
  clean_names()
